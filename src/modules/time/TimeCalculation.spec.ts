...
const now = new Date()
const gameStart0m = new GameEvent(EventEnum.GAME_TIMER_START, addSeconds(now, 0), null, null)
const gameEnd90m = new GameEvent(EventEnum.GAME_TIMER_STOP, addSeconds(now, 90 * 60), null, null)
...
describe('time calculation tests', () => {
    ...
    describe('getFieldDurationFromPlayerTimerEvents', () => {
        ...
        test('If game timer is paused mid play, returns proper number of seconds', () => {
            const startEvent = new GameEvent(EventEnum.PLAYER_TO_FIELD, addSeconds(now, 10), null, null)
            const midwayGameStop = new GameEvent(EventEnum.GAME_TIMER_STOP, addSeconds(now, 25), null, null)
            const midwayGameStart = new GameEvent(EventEnum.GAME_TIMER_START, addSeconds(now, 35), null, null)
            const endEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, addSeconds(now, 45), null, null)
    ...
    describe('getGoalingDurationFromPlayerTimerEvents', () => {
        ...
        test('If game timer is paused mid play, returns proper number of seconds', () => {
            const startEvent = new GameEvent(EventEnum.PLAYER_TO_GOAL, addSeconds(now, 10), null, null)
            const midwayGameStop = new GameEvent(EventEnum.GAME_TIMER_STOP, addSeconds(now, 25), null, null)
            const midwayGameStart = new GameEvent(EventEnum.GAME_TIMER_START, addSeconds(now, 35), null, null)
            const endEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, addSeconds(now, 45), null, null)
    ...
    describe('getBenchingDurationFromPlayerTimerEvents', () => {
        test('start only (missing end) returns diff between start and now provided in 2nd parameter', () => {
            const startAt = addSeconds(now, 0)
            const startEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, now, null, null)
        ...
        test('start + end + start + end returns diff between spans omitting space between stop and start', () => {
            ...
            const startEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, startAt, null, null)
            const endEvent = new GameEvent(EventEnum.PLAYER_TO_FIELD, stopAt, null, null)
            const restartEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, restartAt, null, null)
            const reStopEvent = new GameEvent(EventEnum.PLAYER_TO_FIELD, reStopAt, null, null)
        ...
        test('If game timer is paused mid play, returns proper number of seconds', () => {
            const startEvent = new GameEvent(EventEnum.PLAYER_TO_BENCH, addSeconds(now, 10), null, null)
            const midwayGameStop = new GameEvent(EventEnum.GAME_TIMER_STOP, addSeconds(now, 25), null, null)
            const midwayGameStart = new GameEvent(EventEnum.GAME_TIMER_START, addSeconds(now, 35), null, null)
            const endEvent = new GameEvent(EventEnum.PLAYER_TO_FIELD, addSeconds(now, 45), null, null)
    ...
    describe('createIntervalPairsFrom', () => {
        ...
        test('start + end returns interval of start + end', () => {
            ...
            const startEvent = new GameEvent(EventEnum.GAME_TIMER_START, startAt, null, null)
            const endEvent = new GameEvent(EventEnum.GAME_TIMER_STOP, endAt, null, null)
            const resultingIntervals = createIntervalPairsFrom(
                [startEvent, endEvent],
                EventEnum.GAME_TIMER_START,
                [EventEnum.GAME_TIMER_STOP],
        ...
        test('start + end + start + end returns diff between spans omitting space between stop and start', () => {
            ...
            const startEvent = new GameEvent(EventEnum.GAME_TIMER_START, startAt, null, null)
            const endEvent = new GameEvent(EventEnum.GAME_TIMER_STOP, endAt, null, null)
            const startEvent2 = new GameEvent(EventEnum.GAME_TIMER_START, startAt2, null, null)
            const endEvent2 = new GameEvent(EventEnum.GAME_TIMER_STOP, endAt2, null, null)
            const resultingIntervals = createIntervalPairsFrom(
        ...
        test('Items presented in weird orders should be discarded as invalid timeline events', () => {
            ...
            const endAt2 = addSeconds(now, 25)
            const startEvent = new GameEvent(EventEnum.GAME_TIMER_STOP, startAt, null, null)
            const endEvent = new GameEvent(EventEnum.GAME_TIMER_START, endAt, null, null)
            const startEvent2 = new GameEvent(EventEnum.GAME_TIMER_START, startAt2, null, null)
            const endEvent2 = new GameEvent(EventEnum.GAME_TIMER_STOP, endAt2, null, null)
            const resultingIntervals = createIntervalPairsFrom(
                [startEvent, endEvent, startEvent2, endEvent2],
